...
args.num_channels = 128 # number of channels for resnet
...
args.fix_si_pnorm_value = 12.0  # custom fixed SI-pnorm value (must go with --fix_si_pnorm flag; default: -1 --- use init SI-pnorm value)",
...
fix_si_pnorm(model, args.fix_si_pnorm_value, model_name=args.model)
sd_A = deepcopy(model.state_dict())

model.load_state_dict(sd_B)
fix_si_pnorm(model, args.fix_si_pnorm_value, model_name=args.model)
sd_B = deepcopy(model.state_dict())
